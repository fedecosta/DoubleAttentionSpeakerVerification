...
python scripts/labels_versioner.py \
	--labels_file_folder './labels/augmentation_experiments/train/voxceleb_1_augmented/' \
	...
	--dump_folder_name './labels/augmentation_experiments/train/voxceleb_1_augmented/' \
