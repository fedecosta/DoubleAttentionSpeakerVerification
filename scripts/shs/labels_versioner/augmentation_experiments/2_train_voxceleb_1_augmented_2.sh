...
python scripts/labels_versioner.py \
	--labels_file_folder './labels/augmentation_experiments/train/voxceleb_1_augmented_2/' \
	--labels_file_name 'train_labels.ndx' \
	--prepend_directory '/home/usuaris/veussd/DATABASES/Common_Voice/cv11.0/dev_data_augmentation_renamed/' \
	--dump_folder_name './labels/augmentation_experiments/train/voxceleb_1_augmented_2/' \
