...
python scripts/model_evaluator.py \
	...
	'./labels/valid/voxceleb_2/23_04_23_10_47_08_3nwi3vvk_decent-sponge-75/sv_clients_hard_reduced.ndx' \
	'./labels/valid/voxceleb_2/23_04_23_10_47_41_sk8auwvv_treasured-frost-76/sv_impostors_hard_reduced.ndx' \
	...
	> logs/console_output/model_evaluator/validation_improvements/sv_hard_reduced.log 2>&1