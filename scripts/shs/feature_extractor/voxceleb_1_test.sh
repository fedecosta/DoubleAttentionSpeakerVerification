...
python scripts/feature_extractor.py \
	...
	--audio_paths_file_name 'voxceleb_1_test_feature_extractor_paths.lst' \
	--prepend_directory '/home/usuaris/veussd/DATABASES/VoxCeleb/VoxCeleb1/test/' \
	--dump_folder_name '/home/usuaris/veussd/federico.costa/datasets/voxceleb_1/test/' \
	--sampling_rate 16000 \
	--n_fft_secs 0.025 \
	--win_length_secs 0.025 \
	--hop_length_secs 0.010 \
	--n_mels 80 \
    > logs/console_output/feature_extractor/voxceleb_1_test.log 2>&1